      ...
      <div className="container">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {memberTypes.map((type, index) => {
            ...
            return (
              <Card key={index} className="bg-[#002b54] border border-[rgba(0,43,84,0.04)] rounded-tl-[40px] rounded-tr-[4px] rounded-br-[24px] rounded-bl-[24px] drop-shadow-[0px_4px_16px_rgba(117,140,162,0.1)] text-white flex flex-col">
                <CardHeader>
