...
const Menajerler = () => {
  const features = [
    ...
    "Detaylı raporlama",
    "Öncelikli casting bildirimleri",
  ];

  const pricing = [
    { plan: "Aylık", price: "₺299", period: "/ay" },
    { plan: "Yıllık", price: "₺2.990", period: "/yıl", badge: "%17 İndirim" },
  ];
        ...
        <section className="py-20 bg-gradient-to-b from-primary/10 to-background">
          <div className="container">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <h1 className="text-4xl md:text-6xl font-light">Menajerler</h1>
              <p className="text-xl text-muted-foreground">
                Yetenek kadronuzu yönetin, başvuruları takip edin ve casting fırsatlarıyla bağlantı kurun.
              </p>
            </div>
          </div>
        </section>
